            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama_menu" class="col-lg-2 col-lg-offset-1 control-label">Nama</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="id_kategori_menu" class="col-lg-2 col-lg-offset-1 control-label">Kategori Menu</label>
                        <div class="col-lg-6">
                            <select name="id_kategori_menu" id="id_kategori_menu" class="form-control" required>
                                <option value="">Pilih Kategori Menu</option>
                                @foreach ($kategori_menu as $key => $item)
