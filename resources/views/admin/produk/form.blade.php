        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group row">
                      <label for="deskripsi_produk" class="col-lg-2 col-lg-offset-1 control-label">Deskripsi</label>
                      <div class="col-lg-6">
                          <textarea type="text-textarea" name="deskripsi_produk" id="deskripsi_produk " class="form-control" required autofocus></textarea>
                          <span class="help-block with-errors"></span>
                      </div>
                  </div>
                    <div class="form-group row">
                        <label for="gambar_produk" class="col-lg-2 col-lg-offset-1 control-label">Gambar</label>
                        <div class="col-lg-6">
                            <input type="file" name="gambar_produk" id="gambar_produk" class="form-control"
                            onchange="preview('.tampil-produk', this.files[0])">
                        <span class="help-block with-errors"></span>
                        <br>
                        <div class="tampil-produk">
                          <p>Your Image will be right here</p>
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <div class="form-check">
			                         <input type="radio" class="form-check-input" name="status_produk" value="1" required></input>
			                            <label class="form-check-label" for="">Aktif</label>
  			                 </div>
                         <div class="form-check">
                              <input type="radio" class="form-check-input" name="status_produk" value="0" required></input>
                                 <label class="form-check-label" for="">Tidak Aktif</label>
                        </div>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div> -->
