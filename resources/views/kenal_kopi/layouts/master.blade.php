...
<script src="{{ asset('kenal_kopi/js/move-top.js') }}"></script>
<script src="{{ asset('kenal_kopi/js/easing.js') }}"></script>
...
<!-- main slider-banner -->
<script src="{{asset('kenal_kopi/js/jquery-1.11.1.min.js')}}"></script>
<script href="{{asset('kenal_kopi/js/skdslider.min.js')}}"></script>
